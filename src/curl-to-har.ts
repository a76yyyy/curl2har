import { errorResult, getUrlQueryArray, NewURL, successResult } from './apipost-tools';
...
function curl_to_har(str: string) {
  try {
    ...
    if (
      Object.prototype.toString.call(curlObj) == '[object Object]' &&
      curlObj.hasOwnProperty('url')
    ) {
